 <?php
        ...
        try {
            ...
            echo "<p>Error fetching students data: " . htmlspecialchars($e->getMessage()) . "</p>";
            $students = [];
        }
        ?>
 <!DOCTYPE html>
 ...
 <body>
             ...
             <table>
                 ...
                 <tbody>
                     ...
                     <tr>
                         ...
                         <td>
                             <a href="#"
                                 onclick="openEditModal('<?php echo htmlspecialchars($student['student_id']); ?>', '<?php echo htmlspecialchars($student['student_name']); ?>', '<?php echo htmlspecialchars($student['faculty']); ?>', '<?php echo htmlspecialchars($student['email']); ?>')">
                                 <img src="/SCM_System/app/assets/edit.png" alt="Edit" width="20" />
                             </a>
                             <a href="#"
                                 onclick="openDeleteModal('<?php echo htmlspecialchars($student['student_id']); ?>', '<?php echo htmlspecialchars($student['student_name']); ?>')">
     ...
     <div id="editModal" class="modal">
         <div class="modal-content">
             ...
             <div id="editLoading" class="loading">Updating student...</div>
         </div>
     </div>
     ...
     function openEditModal(id, name, faculty, email) {
     ...
     document.getElementById('editForm').addEventListener('submit', async function(e) {
         ...
         try {
             const response = await fetch('/SCM_System/app/api/update_student.php', {
                 method: 'PUT',
                 headers: {
     ...
     async function confirmDelete() {
         ...
         try {
             const response = await fetch('/SCM_System/app/api/delete.php', {
                 method: 'DELETE',
                 headers: {
                     'Content-Type': 'application/json'
                 },
